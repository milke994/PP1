...
public class DesignatorStActualPars extends DesignatorStatement {

    private Designator Designator;
    private ActualPars ActualPars;

    public DesignatorStActualPars (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStActualPars(\n");
